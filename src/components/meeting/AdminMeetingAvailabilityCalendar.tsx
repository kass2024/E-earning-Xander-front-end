  ...
  return (
    <div className="flex h-[min(780px,calc(100vh-12rem))] min-h-[560px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2 border-b border-slate-200 px-4 py-3">
        ...
        <h2 className="min-w-[140px] flex-1 text-lg font-semibold text-[#012F6B]">{headerLabel}</h2>
      ...
      <div className="flex min-h-0 flex-1">
            ...
            <div className="flex min-h-0 flex-1 flex-col overflow-auto p-4">
              <Calendar
                ...
                classNames={{
                  ...
                  caption_label: "text-base font-semibold text-[#012F6B]",
                  head_cell: "text-slate-500 w-full font-medium text-xs uppercase",
                  row: "flex w-full mt-1",
                  cell: "relative aspect-square w-full p-0.5 text-center",
                  day: cn(
                    "h-full w-full rounded-lg font-medium hover:bg-[#012F6B]/10",
                    "aria-selected:bg-[#012F6B] aria-selected:text-white"
                  ),
                  day_today: "ring-2 ring-[#E01C21] ring-offset-1",
                  day_range_middle: "rounded-none bg-[#012F6B]/15 text-[#012F6B]",
                }}
              />
          ...
          <aside className="flex w-full shrink-0 flex-col border-l border-slate-200 bg-white sm:w-[340px] lg:w-[380px]">
            <div className="flex items-start justify-between border-b border-slate-100 px-4 py-3">
              <div className="min-w-0 pr-2">
                <p className="text-xs font-medium uppercase tracking-wide text-[#F2A65A]">
                  {isCohort ? "Cohort session" : "Availability"}
                </p>
                <h3 className="truncate text-base font-semibold text-[#012F6B]">{rangeSummary}</h3>
            ...
            <div className="flex-1 space-y-4 overflow-y-auto px-4 py-4">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        recurrence === opt.value
                          ...
                          : "border-slate-200 text-slate-600 hover:border-[#012F6B]/40"
                      )}
                    >
                      {opt.label}
                    </button>
                    ...
                    return (
                      <label
                        ...
                        className={cn(
                          ...
                          checked
                            ? "border-[#012F6B] bg-[#012F6B]/10 text-[#012F6B]"
              ...
              <div className="rounded-lg bg-[#012F6B]/5 px-3 py-2 text-sm text-[#012F6B]">
            ...
            <div className="space-y-2 border-t border-slate-100 p-4">
              {(!isCohort ? !isBlocked : true) && (
                <div className="flex flex-col gap-2 sm:flex-row">
                  <Button
                    type="button"
                    className="flex-1 bg-[#012F6B] hover:bg-[#012F6B]/90"
        ...
        {!panelOpen && (
          <div className="hidden w-[280px] shrink-0 flex-col items-center justify-center border-l border-dashed border-slate-200 bg-slate-50/50 p-6 text-center lg:flex">
            <CalendarDays className="mb-3 h-10 w-10 text-[#012F6B]/30" />
