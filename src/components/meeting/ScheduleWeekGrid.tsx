            ...
            >
              ...
              <span
                className={cn(
                  ...
                  isToday && "bg-[#012F6B] text-white",
                  !isToday && isSelected && "bg-[#012F6B]/15 text-[#012F6B]",
            ...
            return (
              ...
              >
                ...
                {drag?.dayIndex === dayIndex && (
                  <div
                    className="pointer-events-none absolute inset-x-1 z-30 rounded-md border-2 border-dashed border-[#012F6B] bg-[#012F6B]/15"
                    style={blockStyle(
                ...
                {nowLine?.dayIndex === dayIndex && (
                  ...
                  >
                    <div className="h-2.5 w-2.5 -translate-x-1/2 rounded-full bg-[#E01C21]" />
                    <div className="h-0.5 flex-1 bg-[#E01C21]" />
                  </div>
                )}
