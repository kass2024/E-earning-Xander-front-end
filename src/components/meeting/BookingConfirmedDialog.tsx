    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md rounded-2xl p-0 overflow-hidden gap-0 border-slate-200">
        <div className="px-6 pt-8 pb-4 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#012F6B]/10">
            <CheckCircle2 className="h-8 w-8 text-[#012F6B]" />
          </div>
          <DialogHeader className="space-y-2 text-center sm:text-center">
            <DialogTitle className="text-2xl font-bold text-[#012F6B]">Booking confirmed</DialogTitle>
            <DialogDescription className="text-sm text-slate-600">
              <span className="inline-flex items-center justify-center gap-1.5">
                <Mail className="h-3.5 w-3.5" />
                Email sent to <strong className="text-[#012F6B]">{email}</strong>
              </span>
            </DialogDescription>
          </DialogHeader>
        </div>
        ...
        <div className="mx-6 mb-6 rounded-xl border border-slate-200 bg-slate-50 p-4">
          <div className="flex gap-3">
            <div className="shrink-0 rounded-lg border border-slate-200 bg-white px-2 py-2 text-center min-w-[52px]">
              <div className="text-[10px] font-bold uppercase tracking-wide text-[#012F6B]">Booked</div>
              <div className="text-lg font-bold text-[#012F6B] leading-none mt-1">&#10003;</div>
            </div>
            <div className="min-w-0">
              <p className="font-semibold text-[#012F6B]">Online consultation</p>
        ...
        <DialogFooter className="border-t border-slate-100 px-6 py-4 sm:justify-center">
          <Button
            ...
            className="rounded-full bg-[#012F6B] hover:bg-[#0a3d7a] px-8"
          >
            Close
          </Button>
        </DialogFooter>
