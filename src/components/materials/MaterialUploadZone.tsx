    ...
    <div className="space-y-4">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Any file type — uploaded directly to your Xander Learning Hub pCloud folder (not stored on the server)
        </p>
        <Button
          type="button"
          variant="outline"
          ...
          {uploading && uploadProgress != null && (
            <div className="space-y-1.5">
              ...
              <div className="h-2 rounded-full bg-muted overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[#0A0A0A] to-[#E01C21] transition-all duration-300"
