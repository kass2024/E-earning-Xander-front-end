  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
      {Array.from({ length: 6 }).map((_, i) => (
        ...
        >
          <div className="aspect-video bg-gradient-to-br from-[#0A0A0A]/10 to-[#E01C21]/10" />
  ...
  return (
    <>
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-[#0A0A0A]/15 bg-gradient-to-r from-[#0A0A0A]/[0.06] via-white to-[#E01C21]/[0.08] p-3 shadow-sm">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
                ...
                return (
                  <Button
                    ...
                    className={cn(
                      ...
                      active
                        ? "bg-[#0A0A0A] hover:bg-[#012F6B] shadow-sm"
            ...
            <div className="flex items-center gap-2 ml-auto shrink-0">
              ...
              <Button
                ...
                className={cn("h-8 w-8", view === "grid" && "bg-[#0A0A0A] hover:bg-[#012F6B]")}
              ...
              <Button
                ...
                className={cn("h-8 w-8", view === "list" && "bg-[#0A0A0A] hover:bg-[#012F6B]")}
              ...
              {filtered.map((material, index) => {
                ...
                return (
                  ...
                  >
                    <button
                      type="button"
                      className="relative w-full aspect-video bg-gradient-to-br from-[#0A0A0A]/8 to-[#E01C21]/10 flex items-center justify-center overflow-hidden"
                    ...
                    <div className="p-4 space-y-2">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <Badge variant="outline" className="shrink-0 text-[10px] border-[#E01C21]/40">
