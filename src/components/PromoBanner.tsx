...
const PromoBanner = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: banner.background_color || "#254D81" }}
      role="region"
      ...
      >
        <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 pr-8 sm:pr-10">
          ...
          {banner.headline?.trim() && (
            <span className="font-extrabold text-[#F2A65A] uppercase tracking-wide text-sm sm:text-base">
              {banner.headline}
            </span>
          )}
          ...
          {showTimer && (
            <div className="flex items-center gap-2">
              <span className="hidden md:inline text-[#F2A65A] font-semibold italic text-xs">
                Flash Sale Ends In
              </span>
              <div className="flex items-center gap-1.5">
                {[
                  ...
                  >
                    <div className="text-[#E01C21] font-bold text-sm leading-none">{unit.value}</div>
          ...
          {showCoupon && (
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                className="rounded-md bg-[#F2E6A0] hover:bg-[#F2D96A] text-[#012F6B] font-extrabold px-3 py-1.5 text-xs sm:text-sm tracking-wide"
                onClick={(e) => {
                  e.stopPropagation();
