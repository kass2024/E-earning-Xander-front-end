    ...
    <div className="space-y-3 rounded-xl border border-slate-200 bg-slate-50/50 p-3">
      ...
      <div>
        <p className="text-xs font-semibold text-slate-700 flex items-center gap-1.5">
          <CalendarDays className="h-3.5 w-3.5 text-[#012F6B]" />
          ...
          return (
            <div
              ...
              className={cn(
                ...
                activeInGroup ? "border-[#012F6B] shadow-sm ring-1 ring-[#012F6B]/20" : "border-slate-200"
              )}
            >
                        ...
                        className={cn(
                          ...
                          selected
                            ...
                            : disabled
                              ...
                              : "border-slate-200 hover:border-[#012F6B]/50 bg-white"
                        )}
                      >
