    ...
    <div className="flex flex-col lg:flex-row gap-6">
        ...
        <nav className="lg:w-52 shrink-0 space-y-1 text-sm">
          ...
          {visibleSections.map((section) => (
            <button
              ...
              className="w-full flex items-center gap-1.5 px-2 py-1.5 rounded-md text-left text-slate-700 hover:bg-slate-100 hover:text-[#012F6B]"
            >
      ...
      <div className="flex-1 min-w-0 space-y-4">
        ...
        <div className="flex justify-end gap-2 text-xs">
          <Button type="button" variant="ghost" size="sm" className="h-7 text-[#012F6B]" onClick={expandAll}>
            Expand all
          </Button>
          <Button type="button" variant="ghost" size="sm" className="h-7 text-[#012F6B]" onClick={collapseAll}>
            Collapse all
          </Button>
        </div>
        ...
        >
          <AccordionItem value="general" id="course-section-general" className="border-b last:border-b-0">
            <AccordionTrigger className="hover:no-underline px-4 py-3 bg-slate-100/90 text-[#012F6B] font-semibold">
