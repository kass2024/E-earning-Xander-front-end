  ...
  return (
    <div className="space-y-3">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? "border-[#012F6B] bg-[#012F6B]/5 ring-2 ring-[#012F6B]/20"
                  : "border-slate-200 bg-white hover:border-[#012F6B]/30"
              )}
            >
              {active && (
                <span className="absolute top-2 right-2 flex h-5 w-5 items-center justify-center rounded-full bg-[#012F6B] text-white">
                  <Check className="h-3 w-3" />
                </span>
              )}
              <div className="flex items-center gap-1.5 mb-1">
                <Icon className={cn("h-4 w-4", active ? "text-[#012F6B]" : "text-slate-400")} />
                <span className="text-sm font-semibold text-slate-800">{preset.label}</span>
              </div>
              <span className={cn("text-xs font-medium", active ? "text-[#012F6B]" : "text-slate-500")}>
      ...
      {selectedCount === 0 ? (
        ...
        <p className="text-xs font-medium text-[#012F6B]">
