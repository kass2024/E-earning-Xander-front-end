  ...
  return (
    <div className="space-y-5">
              ...
              <button
                ...
                className={cn(
                  ...
                  selected
                    ...
                    : "border-slate-200 bg-white text-slate-600 hover:border-[#012F6B]/40"
                )}
              >
      ...
      <div className="rounded-xl border border-slate-200 p-4 space-y-3">
            ...
            <label
              className={cn(
                ...
                value.course_ids.length === 0
                  ? "border-[#012F6B] bg-[#012F6B]/5"
                  : "border-slate-200 hover:border-[#012F6B]/30"
              )}
            >
              <input
                type="radio"
        ...
        {value.course_id ? (
          <p className="text-xs text-[#012F6B] font-medium">1 course selected</p>
        ) : isAdmin ? (
