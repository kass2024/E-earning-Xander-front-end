  ...
  return (
    ...
    <header
      ...
      className={cn(
        ...
        "border-b border-white/10 bg-gradient-to-r from-[#012F6B] via-[#254D81] to-[#012F6B] text-white shadow-lg",
      ...
      <div className="container mx-auto flex max-w-3xl items-center justify-between gap-4 px-4 py-5 sm:py-6">
        ...
        {slug && (
          ...
          <Button
            ...
            className="shrink-0 rounded-full bg-white/95 text-[#012F6B] hover:bg-white"
