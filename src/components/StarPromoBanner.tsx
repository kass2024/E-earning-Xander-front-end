    ...
    >
      <div className="relative pointer-events-auto animate-star-blink">
        <button
          ...
          className="absolute -top-1 -right-1 z-10 w-7 h-7 rounded-full bg-[#012F6B]/90 hover:bg-[#012F6B] text-white flex items-center justify-center shadow-md transition-colors"
