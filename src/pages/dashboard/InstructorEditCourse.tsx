...
const TAB_CLASS =
  "data-[state=active]:bg-[#012F6B] data-[state=active]:text-white rounded-lg text-sm";
  ...
  if (loading) {
    return (
      <div className="flex justify-center py-20">
        <Loader2 className="h-10 w-10 animate-spin text-[#012F6B]" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 pb-10 max-w-4xl">
      ...
      <Card className="overflow-hidden border-0 shadow-lg ring-1 ring-[#012F6B]/10">
        ...
        <CardHeader className="border-b border-[#012F6B]/10 bg-[#012F6B]/[0.03] pb-4">
        ...
        <CardContent className="p-5 sm:p-6">
          <form onSubmit={handleSubmit}>
            <Tabs defaultValue="basics" className="space-y-5">
              ...
              <TabsContent value="basics" className="space-y-4 mt-0">
                <div className="space-y-1.5">
                  ...
                  <select
                    id="program"
                    className="flex h-11 w-full rounded-md border border-[#012F6B]/15 bg-background px-3 text-sm"
                    value={programId ?? ""}
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    rows={2}
                    className="border-[#012F6B]/15 resize-none"
                  />
                </div>
            ...
            <div className="mt-8 flex flex-col-reverse gap-2 border-t border-[#012F6B]/10 pt-6 sm:flex-row sm:justify-between">
              <Button type="button" variant="ghost" onClick={() => navigate("/dashboard/my-courses")}>
                <ArrowLeft className="mr-2 h-4 w-4" />
                Back
              </Button>
              <Button type="submit" disabled={saving} className="bg-[#012F6B] hover:bg-[#254D81] h-11 px-6">
