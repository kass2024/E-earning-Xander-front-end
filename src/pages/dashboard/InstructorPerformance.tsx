          ...
          <CardContent className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data?.enrollmentsByMonth ?? []}>
                ...
                <Tooltip />
                <Bar dataKey="count" fill="#254D81" name="Enrollments" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
          ...
          <CardContent className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data?.earningsByMonth ?? []}>
                ...
                <Bar dataKey="earnings" fill="#254D81" name="Your earnings" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
          ...
          <CardContent className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={courseChartData}>
                ...
                <Bar yAxisId="right" dataKey="earnings" fill="#254D81" name="Earnings ($)" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
