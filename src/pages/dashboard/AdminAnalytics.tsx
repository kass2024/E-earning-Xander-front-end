...
const CHART_COLORS = ["#0A0A0A", "#E01C21", "#0a3d7a", "#012F6B", "#D9893A", "#64748b"];
    ...
    <div className="space-y-6">
      ...
      >
        <Button
          onClick={() => void reload()}
          disabled={refreshing}
          className="bg-[#E01C21] hover:bg-[#E79A4D] text-slate-900"
        >
          ...
          <CardContent className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data?.revenueByMonth ?? []}>
                ...
                <Bar dataKey="manual" fill="#E01C21" name="Manual" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
