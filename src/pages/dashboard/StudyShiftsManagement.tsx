  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
            <CalendarClock className="h-7 w-7 text-[#012F6B]" />
            Study Shifts
          </h1>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <Button onClick={() => openCreate()} className="bg-[#012F6B] hover:bg-[#012F6B]/90">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          { label: "Total shifts", value: stats.total, icon: CalendarDays, color: "text-[#012F6B]" },
      ...
      {loading ? (
        ...
        <Card className="border-dashed">
          <CardContent className="py-16 text-center">
            ...
            <Button onClick={() => openCreate()} className="mt-4 bg-[#012F6B]">
              <Plus className="h-4 w-4 mr-2" />
            ...
            >
              <div className="px-3 py-2.5 border-b border-slate-100 bg-slate-50/80 flex items-center justify-between gap-2">
                <div className="min-w-0">
                  <p className="text-sm font-bold text-[#012F6B]">{day.short}</p>
                ...
                <Badge
                  ...
                  className={cn(
                    ...
                    day.shifts.length > 0 && "bg-[#012F6B] hover:bg-[#012F6B]/90"
                  )}
                >
                  {day.shifts.length}
                </Badge>
              ...
              <div className="flex-1 p-2 space-y-2">
                {day.shifts.length === 0 ? (
                  <button
                    ...
                    className="w-full h-full min-h-[100px] rounded-lg border border-dashed border-slate-200 py-4 text-xs text-slate-400 hover:border-[#012F6B]/40 hover:text-[#012F6B] hover:bg-[#012F6B]/5 transition-colors"
                  >
                    + Add shift
                  </button>
                ) : (
          ...
          {listGrouped.map((day) => (
            <Card key={day.value} className="border-slate-200/80 overflow-hidden">
              <CardHeader className="py-3 px-4 bg-slate-50/80 border-b">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-sm font-semibold text-[#012F6B]">{day.label}</CardTitle>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} disabled={saving} className="bg-[#012F6B]">
