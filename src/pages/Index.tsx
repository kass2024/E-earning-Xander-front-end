...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative public-page-offset pb-0 overflow-hidden bg-gradient-to-br from-[#012F6B] via-[#0a3d7a] to-[#012F6B]">
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_70%_50%,#F2A65A_0%,transparent_50%)]" />
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-8 items-center">
            ...
            >
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-[3.25rem] font-bold leading-[1.12] text-white mb-4">
                ...
                <br />
                <span className="text-[#F2A65A]">With {HUB.name}</span>
              </h1>
              ...
              <div className="rounded-xl bg-black/25 backdrop-blur-sm p-3 sm:p-4 max-w-xl">
                <form onSubmit={handleHeroSearch} className="flex flex-col sm:flex-row gap-2">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="h-12 sm:h-14 px-8 rounded-lg bg-[#F2A65A] hover:bg-[#E69545] text-[#012F6B] font-bold text-base shadow-lg shrink-0"
                  >
                  ...
                  {HERO_QUICK_LINKS.map((link, i) => (
                    <span key={link.to} className="flex items-center">
                      ...
                      <button
                        ...
                        className="hover:text-[#F2A65A] transition-colors"
                      >
                        {link.label}
                      </button>
                    </span>
              ...
              <div className="flex flex-wrap gap-3 mt-5 max-w-xl">
                <Button
                  size="lg"
                  className="h-11 px-6 rounded-lg bg-white text-[#012F6B] hover:bg-white/90 font-semibold"
        ...
        <div className="border-t border-white/10 bg-[#012F6B]/80 backdrop-blur-sm">
              ...
              {TRUST_ITEMS.map((item) => (
                ...
                >
                  <div className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center shrink-0">
                    <item.icon className="h-5 w-5 text-[#F2A65A]" />
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {STATS.map((s) => (
              <div key={s.label} className="text-center">
                <p className="text-2xl md:text-3xl font-bold text-[#012F6B]">{s.value}</p>
          ...
          <FadeIn>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative rounded-2xl overflow-hidden shadow-lg aspect-[4/3] lg:aspect-auto lg:h-[400px] group">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#012F6B]/80 to-transparent" />
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  <Globe2 className="h-8 w-8 text-[#F2A65A] mb-2" />
                ...
                <ul className="space-y-3 mb-8">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-slate-600">
                      <CheckCircle2 className="h-5 w-5 text-[#F2A65A] shrink-0 mt-0.5" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
                <Button
                  className="rounded-md bg-[#012F6B] hover:bg-[#0a3d7a] px-8 h-11"
      ...
      <section className="py-16 md:py-20 bg-slate-50">
        <div className="container mx-auto px-4">
                ...
                <Card className="overflow-hidden border border-slate-200 bg-white shadow-sm hover:shadow-lg transition-all duration-300 group h-full flex flex-col">
                  ...
                  <CardContent className="p-4 flex flex-col flex-1">
                    <div className="flex items-center gap-1 mb-2">
                      {[1, 2, 3, 4, 5].map((i) => (
                        <Star key={i} className="h-3.5 w-3.5 fill-[#F2A65A] text-[#F2A65A]" />
                      ))}
                      <span className="text-xs font-semibold text-[#012F6B] ml-1">5.0</span>
                    </div>
                    <h3 className="font-bold text-[#012F6B] text-base mb-2 line-clamp-2 leading-snug">
                      {course.title}
                    </h3>
                    ...
                    <p className="text-sm font-bold text-[#012F6B] mb-4 mt-auto">
                    ...
                    <div className="flex gap-2">
                      <Button
                        variant="outline"
                        size="sm"
                        className="flex-1 rounded-md border-[#012F6B] text-[#012F6B] hover:bg-[#012F6B]/5 h-9 text-xs font-semibold"
                      ...
                      <Button
                        size="sm"
                        className="flex-1 rounded-md bg-[#F2A65A] hover:bg-[#E69545] text-[#012F6B] h-9 text-xs font-semibold"
                        onClick={() => navigate("/signup")}
                      >
                        Enroll Now
                      </Button>
          ...
          <FadeIn className="text-center mt-10">
            <Button
              size="lg"
              className="rounded-md bg-[#012F6B] hover:bg-[#0a3d7a] px-10 h-12 font-semibold"
              onClick={() => navigate("/courses")}
            >
              View All Programs
            </Button>
              ...
              <StaggerItem key={program.title}>
                ...
                >
                  ...
                  <CardContent className="p-4">
                    <h3 className="font-bold text-[#012F6B] text-base mb-1.5">{program.title}</h3>
            ...
            {LANGUAGE_PROGRAMS.map((lang) => (
              <StaggerItem key={lang.title}>
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#012F6B]/90 via-[#012F6B]/30 to-transparent" />
            ...
            {STUDENT_FEATURES.map((feature) => (
              <StaggerItem key={feature.title}>
                <div className="rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 h-full">
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-base text-[#012F6B] mb-1.5">{feature.title}</h3>
      ...
      {/* ─── LIVE LEARNING ─── */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-[#012F6B] to-[#0a3d7a] text-white">
        <div className="container mx-auto px-4">
          <FadeIn>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <p className="text-sm font-semibold uppercase tracking-wider text-[#F2A65A] mb-3">
                  Live learning
                </p>
                  ...
                  {LIVE_FEATURES.map((item) => (
                    <li key={item} className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                        <Video className="h-4 w-4 text-[#F2A65A]" />
                      </div>
                ...
                <Button
                  className="rounded-md bg-[#F2A65A] text-[#012F6B] hover:bg-[#e69545] font-semibold px-8 h-11"
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="flex items-center gap-3 mb-4 pb-4 border-b border-slate-100">
                      <SafeImage
                        ...
                        fallback={DEFAULT_IMAGE}
                        alt={t.name}
                        className="w-10 h-10 rounded-full ring-2 ring-[#F2A65A]/40"
                      />
                      <div>
                        <p className="font-semibold text-[#012F6B] text-sm">{t.name}</p>
                        <p className="text-xs text-slate-500">{t.role}</p>
                      </div>
                    </div>
                    <div className="rounded-lg bg-slate-50 p-3 border border-slate-100">
                      <p className="text-xs font-semibold text-[#012F6B] mb-1">{t.role} Program</p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-slate-500">Enrolled student</span>
                        <Button
                          size="sm"
                          variant="outline"
                          className="h-7 text-xs rounded-md border-[#012F6B] text-[#012F6B]"
                          onClick={() => navigate("/courses")}
                        >
                          View Details
                        </Button>
          ...
          <FadeIn>
            <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-lg grid lg:grid-cols-2 bg-white">
              <div className="p-8 md:p-10 flex flex-col justify-center">
                <Badge className="w-fit mb-4 bg-[#F2A65A]/15 text-[#012F6B] border-[#F2A65A]/30">
                  For instructors
                </Badge>
                <h2 className="text-2xl md:text-3xl font-bold text-[#012F6B] mb-4">
                ...
                <div className="flex flex-wrap gap-3">
                  <Button
                    className="rounded-md bg-[#012F6B] hover:bg-[#0a3d7a] text-white px-6"
      ...
      {/* ─── FINAL CTA ─── */}
      <section className="py-16 md:py-20 bg-[#012F6B]">
        <FadeIn className="container mx-auto px-4 text-center">
          <BookOpen className="h-12 w-12 text-[#F2A65A] mx-auto mb-6" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="h-12 px-10 rounded-md bg-[#F2A65A] hover:bg-[#E69545] text-[#012F6B] font-bold"
              onClick={() => navigate("/signup")}
            >
              Create free account
            </Button>
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-12 px-10 rounded-md border-[#F2A65A] text-[#F2A65A] hover:bg-[#F2A65A]/10 bg-transparent"
              onClick={() => navigate("/institution-signup")}
            >
              Partner institution sign up
            </Button>
