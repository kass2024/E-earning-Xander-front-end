...
const Courses = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Filters & Courses ù white background */}
            ...
            {courses.map((course) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <Badge className="absolute top-4 right-4 bg-[#E01C21] text-[#012F6B]">
                ...
                <CardContent>
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <Button
                      variant="default"
                      size="sm"
                      className="rounded-full bg-[#E01C21] hover:bg-[#B8181C] text-[#012F6B] font-semibold"
