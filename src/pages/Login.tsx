      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between">
          ...
          {!isInstitutionLocked && (
            <NavLink
              to="/forgot-password"
              className="text-xs font-semibold text-[#012F6B] hover:text-[#F2A65A] transition-colors"
            >
              Forgot password?
            </NavLink>
          )}
        ...
        <div className="relative">
          ...
          <button
            type="button"
            className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#012F6B] transition-colors"
          ...
          <div className="rounded-2xl overflow-hidden shadow-2xl bg-white border border-slate-200">
            <div className="grid md:grid-cols-2">
                  ...
                  {PERKS.map((text) => (
                    <li key={text} className="flex items-start gap-3 text-sm text-white/90">
                      <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/15">
                        <CheckCircle2 className="h-3.5 w-3.5 text-[#F2A65A]" />
                      </span>
                      {text}
                    </li>
                  ))}
              ...
              <div className="p-8 md:p-10">
                <div className="mb-6">
                  <h2 className="text-xl font-bold text-[#012F6B]">Log In</h2>
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                  ...
                  <NavLink
                    to="/signup"
                    className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#012F6B] hover:text-[#F2A65A] transition-colors group"
                  >
                    Sign Up
