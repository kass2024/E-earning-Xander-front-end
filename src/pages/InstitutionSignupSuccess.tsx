  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <main className="container max-w-lg public-page-offset pb-16 px-4">
        ...
        >
          <div className="bg-gradient-to-r from-[#012F6B] to-[#0a3d7a] px-6 py-8 text-center text-white">
            {done ? (
          ...
          <div className="p-6 space-y-4">
            ...
            {done && (
              <div className="rounded-xl bg-[#012F6B]/5 border border-[#012F6B]/15 p-4 flex gap-3 text-sm">
                <Mail className="h-5 w-5 text-[#012F6B] shrink-0" />
                <p>Your login credentials were emailed when you registered. You can sign in once admin approves your institution.</p>
              </div>
            )}
            {done && (
              <Button className="w-full rounded-xl bg-[#012F6B] hover:bg-[#0a3d7a]" onClick={() => navigate("/login")}>
                Go to login
              </Button>
            )}
          </div>
