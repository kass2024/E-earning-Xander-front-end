...
const About = () => {
  return (
    <div className="min-h-screen bg-background">
      <section className="public-page-offset pb-20 px-4 bg-gradient-to-b from-blue-50 via-white to-white border-b border-slate-200">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
            <div>
              <Badge className="mb-4 bg-[#F2A65A]/20 text-[#012F6B] border border-[#F2A65A]/40">
                About us
              </Badge>
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900">
                About Xander Global Scholars
              </h1>
              <p className="text-lg md:text-xl text-slate-700 mb-6 max-w-xl">
                A focused online learning platform connecting learners worldwide with practical training and mentorship.
              </p>
              <p className="text-sm md:text-base text-slate-700 max-w-xl">
                Xander Global Scholars offers structured online programs, clear explanations, and practical tools for learners who
                want to study, work, or grow professionally with the support of trusted mentors.
              </p>
            </div>

            <div className="relative">
              <div
                className="absolute -inset-6 bg-gradient-to-tr from-[#F2A65A]/25 via-sky-400/15 to-blue-400/15 blur-3xl"
                aria-hidden="true"
              />
              <div className="relative rounded-3xl overflow-hidden shadow-[0_24px_60px_rgba(15,23,42,0.25)] bg-slate-900/5 border border-slate-200">
                <img
                  src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1200&auto=format&fit=crop&q=80"
                  alt="Students attending an online session"
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="grid gap-8 md:grid-cols-2">
            <Card className="border border-[#254D81]/15 bg-white shadow-sm hover:shadow-lg hover:border-[#F2A65A]/60 transition-all rounded-2xl">
              <CardHeader>
