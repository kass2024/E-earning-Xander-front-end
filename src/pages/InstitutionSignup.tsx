  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100">
      <main className="container max-w-4xl public-page-offset pb-10 md:pb-16 px-4">
        ...
        >
          <Badge className="mb-4 bg-[#012F6B]/10 text-[#012F6B] hover:bg-[#012F6B]/10 border-[#012F6B]/20">
            <Sparkles className="h-3 w-3 mr-1" /> Partner program
          </Badge>
          <h1 className="text-3xl md:text-4xl font-black text-[#0a3d7a] tracking-tight">
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_280px]">
          ...
          >
            <div className="bg-gradient-to-r from-[#012F6B] to-[#0a3d7a] px-6 py-5 text-white">
            ...
            <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
              <div className="space-y-4">
                <div>
                  <Label className="flex items-center gap-1.5 text-[#0a3d7a] font-medium">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    <Label className="text-[#0a3d7a] font-medium">Last name</Label>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    <Label className="text-[#0a3d7a] font-medium">Institution logo</Label>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        logoPreview ? "border-[#012F6B]/40 bg-[#012F6B]/5" : "border-muted-foreground/25 hover:border-[#012F6B]/40 hover:bg-muted/30",
                      )}
                    >
                      {logoPreview ? (
                ...
                <div className="rounded-xl border bg-slate-50/80 p-4 space-y-3">
                  <Label className="text-[#0a3d7a] font-medium">Promo code (optional)</Label>
              ...
              <div className="rounded-xl bg-[#012F6B]/5 border border-[#012F6B]/15 p-4 flex gap-3">
                <Mail className="h-5 w-5 text-[#012F6B] shrink-0 mt-0.5" />
                <div className="text-sm">
                  <p className="font-semibold text-[#0a3d7a]">Credentials sent by email</p>
              ...
              {!usingPromo && (
                <div className="flex items-center justify-between rounded-xl border px-4 py-3 bg-muted/30">
                  <div className="flex items-center gap-2 text-sm">
                    <CreditCard className="h-4 w-4 text-[#012F6B]" />
                    <span>Platform onboarding fee</span>
                  </div>
                  <span className="font-bold text-[#0a3d7a]">{feeLabel}</span>
                </div>
              )}
              ...
              <Button
                type="submit"
                className="w-full h-12 rounded-xl bg-[#012F6B] hover:bg-[#0a3d7a] text-base font-semibold shadow-lg shadow-[#012F6B]/20"
                disabled={loading}
              >
          ...
          >
            <div className="rounded-2xl border bg-white p-5 shadow-sm">
              <h3 className="font-bold text-[#0a3d7a] mb-3">What happens next</h3>
              <ol className="space-y-3 text-sm">
                {[
                  ...
                  <li key={step} className="flex gap-3">
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#012F6B] text-white text-xs font-bold">{i + 1}</span>
            ...
            <div className="rounded-2xl border border-dashed bg-muted/30 p-5 text-sm text-muted-foreground">
              <Shield className="h-5 w-5 text-[#012F6B] mb-2" />
