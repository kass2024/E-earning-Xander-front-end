              ...
              <Card className="rounded-3xl border border-slate-200/80 bg-white shadow-xl shadow-slate-200/50 overflow-hidden">
                ...
                <CardHeader className="pb-4 pt-8 px-6 md:px-8">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-sm font-semibold text-[#012F6B] leading-snug">
                            ...
                            <button
                              type="button"
                              onClick={() => setStep(1)}
                              className="ml-2 text-[#F2A65A] hover:underline font-semibold"
                            >
                              Edit
                            </button>
                          </p>
                  ...
                  <CardDescription className="text-slate-500 mt-3">
                    Fields marked with <span className="text-[#E01C21]">*</span> are required.
                  </CardDescription>
                </CardHeader>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          <Label htmlFor="fullName" className="text-slate-700">
                            Full name <span className="text-[#E01C21]">*</span>
                          </Label>
                        ...
                        <div className="space-y-1.5 md:col-span-2">
                          <Label htmlFor="phone" className="text-slate-700">
                            Phone <span className="text-[#E01C21]">*</span>
                          </Label>
                          <div className="relative">
